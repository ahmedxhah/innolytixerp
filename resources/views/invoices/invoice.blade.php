                    ...
                    <table style="width: 100%" class="table inventory">
                        <tr>
                            <td style=" !important; text-align:center;" colspan="2">
                                <span style="text-align:center; font-weight:bold; font-size:25px;">INVOICE</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="border: none !important;">
                                <span>Serial No: </span><span style="text-decoration: underline; text-align:right; ">{{@$invoices['date']}}</span><br>

                            </td>
                            <td style="border: none !important; text-align:right">
                                <span>Date: </span><span style="text-decoration: underline; text-align:right; ">{{@$invoices['date']}}</span><br>
                            </td>
                        </tr>
                    </table>
                ...
                <header>
                    <table style="width: 100%" class="table inventory">
                        <tr>
                            ...
                            {{-- {{dd($joborder->unique_id)}} --}}
                            <td>
                                <div class="row" style="margin-bottom: 20px;">
                                    <span>Customer's Name</span>
                                </div>
                                <div class="row">
                                    @if(@$joborder->client->name)
                                    <span style=" font-weight: bold;">{{@$joborder->client->name}}</span>
                                    @endif
                                </div>
                                <div class="row" style="margin-bottom: 20px;">
                                    @if(@$joborder->client->address)
                                    <span>{{@$joborder->client->address}}</span>
                                    @endif
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <span>{{@$joborder->client->phone}}</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                        <span>{{@$joborder->client->srtn_no}}</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                        <span>{{@$joborder->client->ntn_no}}</span>
                                    </div>
                                </div>
                            </td>
                        </tr>
...
// dd($office_detail);
                      ...
                      <table class="balance">
                            <tr>
                                <th>Sub Total</th>
                                <td><span>Rs: </span><span>{{$invoices->sub_total}}/-</span></td>
                            </tr>
                        @if(@$invoices->discount)
                            <tr>
                                <th>Discount {{$invoices->discount}}%</th>
                                <td><span>Rs: </span><span>{{($invoices->discount/100)*$invoices->sub_total}}/-</span></td>
                            </tr>
                        @endif
                        @if(@$invoices->tax)
                        <tr>
                            <th>Tax {{@$invoices->tax}}%</th>
                            <td><span>Rs: </span><span>{{($invoices->tax/100)*$invoices->sub_total}}/-</span></td>
                        </tr>
                        @endif
                        @if(@$invoices->grand_total)
                        <tr>
                            <th>Grand Total</th>
                            <td><span>Rs: </span><span>{{$invoices->grand_total}}/-</span></td>
                        </tr>
                        @endif
                      </table>
                    </article>
